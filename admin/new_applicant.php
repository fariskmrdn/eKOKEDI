                            ...
                            <div class="nk-content-inner">
                                <div class="nk-content-body">
                                    <button class="btn btn-secondary"
                                        onclick="window.location.href='admin/applications.php'"><em
                                        ...
                                        <div class="col-sm-6 col-xl-12 col-xxl-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12" style="text-align:right;">
                                                    <button id="approve" class="btn btn-success"><em
                                                            class="icon ni ni-check-thick"></em>&nbsp; Luluskan
                                                        Permohonan</button>
                                                    <button id="reject" class="btn btn-danger"><em
                                                            class="icon ni ni-na"></em>&nbsp;
...
<script>
    $(document).ready(function () {
        let occupants = '<?php echo $data['name'] ?>';
        let occupantsID = '<?php echo $data['occ_id'] ?>';

        // Approve applications
        $('#approve').on('click', function () {
            Swal.fire({
                title: 'Anda Pasti?',
                text: 'Permohonan Kolej Kediaman bagi ' + occupants + ' akan diterima',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Terima Permohonan',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: 'Kemaskini Sedang Dijalankan',
                        text: 'Kemaskini permohonan sedang dilakukan. Jangan TUTUP atau MUAT SEMULA halaman ini!',
                        ...
                        didOpen: () => {
                            ...
                            $.ajax({
                                method: 'post',
                                data: data,
                                url: 'admin/backend/approve.php',
                                success: function (response) {
                                    if (response === 'ok') {
                                        Swal.fire({
                                            title: 'Berjaya!',
                                            text: 'Permohonan berjaya dikemaskini',
                                            icon: 'success',
                                            allowOutsideClick: false
                                        }).then((result) => {
                                            if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            title: 'Gagal!',
                                            text: 'Permohonan gagal dikemaskini',
                                            icon: 'error'
                                        });
                                    }
        ...
        $('#reject').on('click', function () {
            Swal.fire({
                title: 'Anda Pasti?',
                text: 'Permohonan Kolej Kediaman bagi ' + occupants + ' akan ditolak',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
